...
const ExperienceCard: React.FC<ExperienceCardProps> = ({ role, company, duration, responsibilities }) => (
  <div className="mb-6 last:mb-0 p-4 md:p-5 rounded-lg bg-gray-100 dark:bg-[#181c2a]/80 transition-shadow duration-300 ease-in-out">
    <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-1">{role}</h4>
