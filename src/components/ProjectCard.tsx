...
const ProjectCard: React.FC<ProjectCardProps> = ({ title, description, tech, image, links, badge }) => {
  return (
    <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center rounded-2xl shadow-xl p-0 md:p-0 group bg-transparent w-full">
      <div className="w-full md:w-2/5 flex-shrink-0 flex items-center justify-center">
        <div className="relative w-full h-48 md:h-56 rounded-xl overflow-hidden shadow-lg bg-[#232946] flex items-center justify-center">
