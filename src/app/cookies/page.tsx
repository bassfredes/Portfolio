    ...
    <>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-24 md:pt-28 py-12 md:py-16 max-w-3xl pb-28 sm:pb-32">
        ...
        <section className="mb-8 md:mb-10">
          ...
          <p className="text-base sm:text-lg text-neutral-700 dark:text-neutral-300 mb-4 leading-relaxed">
            We use Google Tag Manager (GTM) to manage analytics and tracking tags,
            including Google Analytics cookies. These are third-party cookies set by
            Google. The information generated by these cookies about your use of our
            website (including your IP address, which is anonymized before storage)
            ...
            of our website, compiling reports on website activity for us, and
            providing other services relating to website activity and internet usage.
          </p>
          <p className="text-base sm:text-lg text-neutral-700 dark:text-neutral-300 mb-4 leading-relaxed">
            We implement Google Consent Mode v2, which allows us to respect your
            privacy choices while still collecting essential information needed for
            our website to function properly. This means that even if you don&apos;t
            consent to analytics cookies, we may still collect anonymized data
            necessary for basic functionality and security.
          </p>
          <p className="text-base sm:text-lg text-neutral-700 dark:text-neutral-300 mb-4 leading-relaxed">
            For more information on Google Analytics cookies and Google Tag Manager,
            see the official Google Analytics documentation and Google&apos;s privacy policy.
          </p>
          <p className="text-base sm:text-lg text-neutral-700 dark:text-neutral-300 mb-4 leading-relaxed">
